...
//        }
     ...
     *
     * In order for a table under consideration to have its p-value included in
     * the final result, it must have a p-value less than the original table's
     * P-value, i.e. Fisher's exact test computes the probability, given the
     * observed marginal frequencies, of obtaining exactly the frequencies
     * observed and any configuration more extreme. By "more extreme," we mean
     * any configuration (given observed marginals) with a smaller probability
     * of occurrence in the same direction (one-tailed) or in both directions
     * (two-tailed).
     *
     * @param a a, b, c, d are the four cells in a 2x2 matrix
     * @param b
